...
статусы и лимиты вывода. Файлы задач будут находиться в `.tasks/tasks/`;
служебный каталог `.tasks/.runtime/` автоматически исключается из Git.
...
Карточки и история останутся в `.tasks/tasks/1.json`, `2.json` и `3.json`.
