...
Планы работ и самостоятельные релизы используют постоянные данные: этапы, реальные задачи,
предметный прогресс и неизменяемый снимок явного выпуска. Обзор и общая история Web показывают «В разработке».
