...
storageDir/runtime для совместимости; новый формат блокируется по реальному каталогу базы.
...
`--local storage migrate` явно переносит прежнюю базу в единый формат. Укажите проектный
`--config`, остановите старые версии клиентов. Сохраняются ID, ключи, Markdown, ревизии,
история и квитанции; незавершённый WAL восстанавливается. Повтор завершённого переноса
