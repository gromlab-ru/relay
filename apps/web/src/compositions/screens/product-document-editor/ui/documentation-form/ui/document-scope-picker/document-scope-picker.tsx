...
import { DOCUMENTATION_SCOPE_MOCKS, DocumentationScopes } from "domains/product-demo";
...
export const DocumentScopePicker = (props: DocumentScopePickerProps) => {
  ...
  const optionItems = DOCUMENTATION_SCOPE_MOCKS.filter(
    (scope) =>
      scope.group === group &&
      ...
      >
        ...
        <div className={styles.footer}>
          <Text size="xs" c="dimmed" role="status">
            Выбрано: {selectedIds.length} · моковые связи
          </Text>
          <Group gap="xs">
            <Button
              size="sm"
