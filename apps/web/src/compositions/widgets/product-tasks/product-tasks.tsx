...
export const ProductTasks = (props: ProductTasksProps) => {
  ...
  const progressDescription = isApplication
    ? "Реализация готова, когда завершена каждая связанная задача."
    : "Учитываются прямые задачи и задачи активных реализаций приложений. Для готовности требования каждая реализация должна быть выполнена.";
