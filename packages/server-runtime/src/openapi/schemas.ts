...
export const schemas = {
  PlansQuery: plansQuerySchema,
  PlanningCandidatesQuery: planningCandidatesQuerySchema,
  PlanningCandidatesPage: planningCandidatesPageSchema,
  PlanningPageQuery: planningPageQuerySchema,
  PlansPage: plansPageSchema,
  PlanSummary: planSummarySchema,
  StagesPage: stagesPageSchema,
  PlanningTasksPage: planningTasksPageSchema,
  PlanMemberships: planMembershipsSchema,
  CreatePlan: createPlanSchema,
  UpdatePlan: updatePlanSchema,
  TransitionPlan: transitionPlanSchema,
  ChangePlanStage: changeStageSchema,
  ChangePlanTasks: changePlanTasksSchema,
  TransferPlanTask: transferPlanTaskSchema,
  PlanningSaved: planningSavedSchema,
  ReleasesQuery: releasesQuerySchema,
  ReleasesPage: releasesPageSchema,
  ReleaseSummary: releaseSummarySchema,
  SaveRelease: saveReleaseSchema,
