import { z } from "zod";
import { actorSchema, parse, text, timestampSchema } from "./validation.js";
...
export const graphQuerySchema = z.strictObject({
  root: z
    ...
    .max(257)
    .optional()
    .describe("Адрес kind:id для обхода; без него весь граф проекта"),
...
/** Разбирает адрес, используемый в CLI и параметрах графовых запросов. */
